package com.aldana.jorge.primerjuego
...
class JuegoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initUI()
        musicaFondo = MediaPlayer.create(this, R.raw.cancion)
        ...
        btnRespuesta.setOnClickListener {
            ...
            if (respuesta.equals("")){
                ...
                if(numeroGenerado==numeroUsuario){
                    sonidoCorrecto()
                    Toast.makeText(this, "Advininaste la esfera escondida por GOKU",Toast.LENGTH_SHORT).show()
                }else{
                    sonidoIncorrecto()
                    Toast.makeText(this, "La esfera escondida es de $numeroGenerado estrellas",Toast.LENGTH_SHORT).show()
